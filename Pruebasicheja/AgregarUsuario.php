    ...
    <div class="container-fluid">
        <div class="row">
          <div class="barra-lateral col-12 col-sm-auto">
            ...
            <form class="form" action="operauser.php" method="post">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            <label for="no.usu" class="form-label">Numero de usuario:</label>
                            <input type="number" id="nousu" name="nousu" class=""><br><br>
            
                            <label for="nom.usuario" class="form-label">Nombre del usuario:</label>
                            <input type="text" id="nomusuario" name="nomusuario" class=""><br><br>

                            <label for="No.dep" class="form-label">Numero de telefono:</label>
                            <input type="text" id="NumTel" name="NumTel" class=""><br><br>
