      ...
      <div class="row">
        <div class="barra-lateral col-12 col-sm-auto">
          <nav class="menu d-flex d-sm-block justify-content-center flex-wrap">
            ...
            $conexion->close();
            ?>
            <form class="form" method="POST" action="InsertarDeptos.php">
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="No_inmueble" name="No.inmueble" class=""><br><br><br>
            
                            
                        </div>
                        <div class="col-md-6">
                            <label for="No.dep" class="form-label">Nombre del departamento:</label>
                            <input type="text" id="No_dep" name="No.dep" class=""><br><br>
                            ...
                            <div class="input-group-prepend" style="margin-left: 0px;">
                                ...
                                <select class="input-group-append" aria-label="Default select example" name="usuarios" id="usuarios">
                    ...
                    <div style="text-align: center;">
                        <div style="display: inline-block;">
                          ...
                          <a class="BotonGuardar" href="Departamentos.html" role="button" style="vertical-align: middle; "data-bs-toggle="button">
